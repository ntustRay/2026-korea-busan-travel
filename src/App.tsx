...
const preparationItems = [
  ...
  { id: "charging", label: "帶充電線與充電器，確認兩支手機都能充電" },
  { id: "offline-files", label: "兩支手機都保存護照與訂房截圖" },
  { id: "insurance", label: "保存旅遊保險保單、理賠電話與緊急聯絡方式" },
  ...
  { id: "taiwan-sim", label: "保留台灣 SIM 收簡訊，關閉數據漫遊" },
  { id: "liquids", label: "隨身液體每瓶不超過 100ml" },
  { id: "medicine", label: "常備藥保留原包裝與成分標示" },
  { id: "toiletries", label: "帶牙刷、牙膏、刮鬍用品與梳子" },
  { id: "rain", label: "帶折疊傘與防滑鞋" },
  { id: "summer", label: "帶帽子、防曬與水壺" },
  { id: "cash", label: "準備韓元現金與可海外交易信用卡" },
  { id: "transit-card", label: "抵達後購買並儲值兩張 T-money／Cashbee" },
  { id: "pass", label: "確認 BIG 5 票型與 2A＋3B 名單後再購買" },
  { id: "luggage-tools", label: "帶行李秤與折疊購物袋" },
